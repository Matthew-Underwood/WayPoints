...
var _static_waypoint_operations : MUW_Static_Waypoints_Operations
var _connected_waypoint_operations : MUW_Connected_Waypoints_Operations
var _switch_waypoint_operations : MUW_Waypoints_Switch_Operations


func _init(
	static_waypoint_operations : MUW_Static_Waypoints_Operations,
	connected_waypoint_operations : MUW_Connected_Waypoints_Operations,
...
func get_static_waypoints() -> MUW_Static_Waypoints_Operations:

	return _static_waypoint_operations


func get_connected_waypoints() -> MUW_Connected_Waypoints_Operations:
