...
var _waypoints_operations_factory : MUW_Waypoints_Operations_Factory
var _waypoint_node_operations_factory : MUW_Node_Waypoints_Operations_Factory

func _init(
	waypoints_operations_factory : MUW_Waypoints_Operations_Factory,
	waypoint_node_operations_factory : MUW_Node_Waypoints_Operations_Factory
):

	_waypoints_operations_factory = waypoints_operations_factory 
