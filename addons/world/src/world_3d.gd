...
func create_waypoints(parent_node : Node, camera : Camera, world : World) -> MUW_Waypoints_Operations:
	return _waypoint_operations_factory.create_3d(parent_node, camera, Vector2(10, 10), world)
